...
FORMAT_OPTIONS = ['API', 'CSV', 'FEATHER', 'GIF', 'GPKG', 'GZ', 'HDF5', 'JPG', 'JSON', 'KML', 'KMZ', 'ODS', 'PDF', 'PNG', 'SHP', 'TAB', 'TAR', 'TXT', 'XLSX', 'XML', 'ZIP', 'Outro']
...
WIDGET_HELP = {'name': 'Qual é o nome ou título do caso de uso?', 
                'url': 'Em qual endereço web (URL) ele está disponível?',
                'url_archive': 'Em qual endereço web (URL) o caso foi arquivado?', 
                'description': 'Do que o caso de uso trata? Dê uma breve descrição.',
                'known_pub': 'A data de publicação, mesmo que aproximada, é conhecida?',
                'pub_date': 'Em que mês e ano o caso de uso foi publicado na internet?', 
                'authors': 'Quem são os autores do caso de uso? Eles podem ser pessoas ou instituições. Instituições devem aparecer primeiro.',
                'email': 'Qual é o endereço de e-mail para contato em caso de necessidade de mais informações sobre o caso de uso?',
                'geo_level': 'Qual o nível da cobertura geográﬁca do caso de uso? Se for global, selecione "Mundial". Se não estiver relacionado a nenhum país, selecione "Não se aplica". Se tratar especificamente de algumas UFs ou municípios do Brasil, selecione a opção correspondente.',
                'type': 'A qual dessas categorias o caso de uso pertence?',
                'topics': 'Quais desses temas são abordados pelo caso de uso?',
                'tags': 'Além dos temas selecionados acima, quais palavras-chave descrevem o caso de uso?',
                'url_source': 'Em qual endereço web (URL) está disponível o código fonte ou a análise relacionados a este caso de uso?',
                'url_image': 'Você tem uma imagem específica para representar o caso de uso no CORDATA? Se sim, informe o endereço web (URL) da imagem.',
                'comment': 'Existe alguma outra informação sobre o caso de uso ou as informações fornecidas que você gostaria de compartilhar?',
                'status_published': 'O caso deve ser publicado no site do CORDATA?',
                'status_review': 'O caso deve ser revisado por outra pessoa da equipe?',
                'data_name': 'Qual o nome ou descrição do conjunto de dados abertos?',
                'data_institution': 'Qual é a instituição responsável por este conjunto de dados?',
                'data_url': 'Em qual endereço web (URL) é possível encontrar este conjunto de dados? Priorize links mais estáveis, se possível.',
                'data_license': 'Qual licença de uso está atribuída ao conjunto de dados?',
                'data_format': 'Em quais extensões de arquivo os dados são fornecidos?',
                'data_periodical': 'O caso de uso consulta este conjunto de dados de forma periódica?'
                }