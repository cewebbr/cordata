...
- A few examples of publicly available datasets: %(examples_datasets)s
- A few examples of organizations that publish datasets on the Web: %(examples_data_providers)s
...
- If the analysis or data mentioned in the work title, abstract, or keywords typically uses or comes from publicly available datasets, you may infer the work likely uses public data.
